        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl p-6 w-full max-w-md">
            <div className="flex items-center justify-between mb-4">
              ...
              <button onClick={() => setShowAddEvent(false)} className="w-8 h-8 rounded-lg flex items-center justify-center hover:bg-slate-100 cursor-pointer">
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="text" className="w-full px-4 py-2.5 rounded-xl bg-slate-50 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-200" placeholder="e.g. iPhone Screen Repair" />
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                ...
                <div>
                  ...
                  <input type="tel" className="w-full px-4 py-2.5 rounded-xl bg-slate-50 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-200" placeholder="0244-XXX-XXX" />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
                ...
                <div>
                  ...
                  <input type="number" className="w-full px-4 py-2.5 rounded-xl bg-slate-50 text-sm text-slate-700 focus:outline-none focus:ring-2 focus:ring-slate-200" placeholder="30" defaultValue={30} />
                </div>
              </div>
              <div className="grid grid-cols-2 gap-3">
                <div>
              ...
              <button onClick={() => setShowAddEvent(false)} className="w-full py-3 rounded-xl text-sm font-semibold text-white cursor-pointer whitespace-nowrap" style={{ background: '#1E5FBE' }}>
                Add Appointment
              </button>
            </div>
          </div>
